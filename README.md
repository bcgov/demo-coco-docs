[![Package Status](https://github.com/bcgov/demo-coco-docs/actions/workflows/publish.yaml/badge.svg)](https://github.com/bcgov/demo-coco-docs/actions/workflows/publish.yaml)
